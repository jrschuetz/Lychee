...
lychee.loginDialog = function() {
    ...
    // Autofill username with username stored locally
    if (localStorage) {
...
lychee.load = function() {
	...
	if (albumID && photoID) {
		...
		if (visible.sidebar() && (albumID==='u' || albumID==='f' || albumID==='s' || albumID==='r')) sidebar.toggle()
...
lychee.setMode = function(mode) {
	...
	$('#button_settings, #button_trash_album, #button_add_album, .header__divider').remove()
	$('#button_trash, #button_move, #button_add, #button_star').remove()
